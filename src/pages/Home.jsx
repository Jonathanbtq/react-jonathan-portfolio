...
function Home() {
    ...
    return (<>
        <HeaderPropos />
        {globalVariables.ProjetWebdiv && globalVariables.ProjetWebdiv === "1" && 
            <WebProjects />
        }
        {globalVariables.mcmobile && globalVariables.mcmobile === "1" && 
            <MobileGame />
        }
        {globalVariables.diginamicdiv && globalVariables.diginamicdiv === "1" && 
            <FormationProjects />
        }
        {globalVariables.mcdiv && globalVariables.mcdiv === "1" && 
            <MinecraftHome />
        }
        <ReseauxFooter />
        <Footer />
